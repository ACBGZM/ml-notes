...
### <span id="15.2">15.2 高斯分布（data compression）</span>
...
### <span id="15.3">15.3 算法（data compression）</span>
...
### <span id="15.4">15.4 开发和评价一个异常检测系统（data compression）</span>
...
### <span id="15.5">15.5 异常检测与监督学习对比（data compression）</span>
...
### <span id="15.6">15.6 选择特征（data compression）</span>
...
### <span id="15.8">15.8 使用多元高斯分布进行异常检测*（data compression）</span>
